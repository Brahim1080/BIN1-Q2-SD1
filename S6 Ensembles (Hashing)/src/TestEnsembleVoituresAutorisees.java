public class TestEnsembleVoituresAutorisees{
	...
	public static void main(String[] args) {	
		...
		if (e.retirerVoiture(new Voiture("1BBB000",""))){
			System.out.println("La methode dit que la voiture a ete supprimer alors qu'elle a deja ete suppromer auparavant");
			return;
		...
		if (!e.voitureAutorisee((new Voiture("1AAA000","")))){
			System.out.println("La voiture 1AAA000 n'est pas autorisee");
			return;
		}
		if (!e.voitureAutorisee((new Voiture("1CCC000","")))){
			System.out.println("La voiture 1CCCC000 n'est pas autorisee");
			return;
		}
		...
		if (e.ajouterVoiture(new Voiture("1AAA000",""))){
			System.out.println("Attention, votre methode annonce que la voiture a ete ajout alors qu'elle y est deja !");
			return;
		}
		System.out.println("***************************");
		System.out.println("\nTOUS LES TEST ONT REUSSIS");
	}
