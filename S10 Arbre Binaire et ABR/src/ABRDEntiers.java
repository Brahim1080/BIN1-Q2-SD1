...
public class ABRDEntiers {
	...
	private boolean contient (NoeudEntier noeudEntier  , int entier) {
		if (noeudEntier == null)
			return false;
		if (noeudEntier.entier == entier)
			return true;
		if (entier <noeudEntier.entier)
			return contient(noeudEntier.gauche, entier);
		return contient(noeudEntier.droit,entier);
